...
/**
	PS::source::dods
	$Id: dods.php 475 2008-06-01 14:20:09Z lifo $

	Halflife::dods mod support for PsychoStats front-end
*/
if (!defined("PSYCHOSTATS_PAGE")) die("Unauthorized access to " . basename(__FILE__));
if (defined("CLASS_PS_SOURCE_DODS_PHP")) return 1;
define("CLASS_PS_SOURCE_DODS_PHP", 1);

include_once(dirname(__DIR__) . '/source.php');

class PS_source_dods extends PS_source {

var $class = 'PS::source::dods';
var $use_roles = true;
